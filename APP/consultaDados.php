...
$cultura = filter_input(INPUT_GET, 'cultura', FILTER_SANITIZE_STRING);
$type = filter_input(INPUT_GET, 'type', FILTER_SANITIZE_STRING);

if($type == 1){
    $propriedade = filter_input(INPUT_GET, 'propriedade', FILTER_SANITIZE_STRING);
    $safra = filter_input(INPUT_GET, 'safra', FILTER_SANITIZE_STRING);
    if($cultura == 1){
    ...
    $id = filter_input(INPUT_GET, 'id_registro', FILTER_SANITIZE_STRING);
    if($cultura == 1){
